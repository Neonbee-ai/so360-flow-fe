...
// fetches of org-static reference data (flow definitions, approval policies,
// roles) that every Flow page re-requests on mount and on each 30s poll tick.
//
// Failures are never cached. Keys include the org id so a tenant/org switch can
// never serve another org's data. Mutations invalidate by prefix.
// =============================================================================
